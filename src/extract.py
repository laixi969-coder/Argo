...
同时标注它是否属于 AI 应用：AI 软件、Agent、模型/Demo、AI 服务、AI 实体产品、工业 AI 或 AI 在行业里的落地记 true；普通服装、美妆、玩具、食品等非 AI 产品记 false。这个字段只用于分类，绝不能因为 false 而否定已成立的需求。
...
{{
  ...
  "is_ai_application": true 或 false,
...
def _extract_one(o, llm):
    try:
        ...
        try:
            ...
            ai_value = data.get("is_ai_application")
            o["is_ai_application"] = (
